...
6. Preserve a recoverable copy of the previous installed app. Update /Applications, verify the installed bundle and run its smoke test. Never replace an app with unsaved work in progress.
